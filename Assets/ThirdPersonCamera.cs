...
public class ThirdPersonCamera : MonoBehaviour {
    ...
    [SerializeField]
    private PlayerMoveAdapted follow;
    [SerializeField]
   ...
   // private CameraNodeFollow nodeFollower;
       ...
       // }
        ...
        switch (camState) {
            ...
            case CamStates.Free:
                ...
                parentRig.RotateAround(characterOffset, followXform.up, freeRotationDegreesPerSond * (Mathf.Abs(rightX) > rightStickThreshold ? rightX : 0f));
    ...
    private void CompensateForWalls(Vector3 fromObject, ref Vector3 toTarget)
    {
        ...
        if (Physics.Linecast(fromObject, toTarget, out wallHit, mask))
        {
            ...
            Vector3 calculatedTargetPosition = wallHit.point + ((fromObject - wallHit.point) * wallBufferAmt);
